...
parser.add_argument('--num_points', '-num_points', help='number of data points to store eventually', default=2047, type=int)
...
Cooking.cook(data_folders, args.output_dir, [args.start_x, args.start_y, args.start_z], args.pdt, args.edt, args.num_points, args.z_const, train_eval_test_split, args.batch_size)